...
const contractsPackageJson = JSON.parse(fs.readFileSync('contracts/package.json', 'utf8'));
contractsPackageJson.version = version;
fs.writeFileSync('contracts/package.json', JSON.stringify(contractsPackageJson, null, 2));

const spdxString = '// SPDX-License-Identifier: MIT';
const versionPrefix = '// LaLaLabs Contracts v';
